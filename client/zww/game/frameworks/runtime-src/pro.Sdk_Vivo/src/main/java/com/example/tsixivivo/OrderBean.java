...
public class OrderBean {
    ...
    public OrderBean(String cpOrderNumber, String extInfo, String notifyUrl, String orderAmount, String productName, String productDesc, RoleInfoBean roleInfoBean) {        this.cpOrderNumber = cpOrderNumber;
