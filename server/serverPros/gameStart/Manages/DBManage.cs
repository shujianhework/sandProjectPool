...
namespace gameStart.Manages
{
    public class DBManage
    {
        ...
        static public bool Select(string connect,string sql,DBDataBase dataBase)
        {
            Log.write(LogLevels.Log, "sql_DBManage_select", "", sql+"   begin");
            SqlConnection sConn = new SqlConnection(connect);
                ...
                using (sdr)
                {
                    ...
                    if (sdr.HasRows)
                    {
                        ...
                        while (sdr.Read())
                        {
                            ...
                            {
                                item[sdr.GetName(i)] = sdr.GetValue(i);
                            }
                            dataBase.onUpdata(idx, item);
                            idx++;
                        }
            ...
            Log.write(LogLevels.Log, "sql_DBManage_select", "", sql + "   end");
            return true;
        }
        //#region 公用方法
        ///// <summary>
        ...
        //public static bool ColumnExists(string connect,string tableName, string columnName)
        //{
        //    string sql = "select count(1) from syscolumns where [id]=object_id('" + tableName + "') and [name]='" + columnName + "'";
        //    object res = GetSingle(tableName, sql);
        //    if (res == null)
        //    {
        //        return false;
        //    }
        ...
        //}
        //public static int GetMaxID(String connectstr, string FieldName, string TableName)
        //{
        //    string strsql = "select max(" + FieldName + ")+1 from " + TableName;
        //    object obj = GetSingle(connectstr, strsql);
        //    if (obj == null)
        //    {
        //        return 1;
        //    }
        ...
        //    }
        //}
        //public static bool Exists(string connect,string strSql)
        //{
        //    object obj = GetSingle(connect, strSql);
        //    int cmdresult;
        ...
        ///// <returns></returns>
        //public static bool TabExists(string connect, string TableName)
        //{
        ...
        //    }
        //}
        //public static bool Exists(string connect,string strSql, params SqlParameter[] cmdParms)
        //{
        //    object obj = GetSingle(connect, strSql, cmdParms);
        //    int cmdresult;
        //    if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
        //    {
        //        cmdresult = 0;
        ...
        //                PrepareCommand(connectionString, cmd, conn, tx, cmdText, cmdParms);
        ...
        //            try
        //            {
        //                PrepareCommand(connectionString, cmd, connection, null, SQLString, cmdParms);
        //                int rows = cmd.ExecuteNonQuery();
        //                cmd.Parameters.Clear();
        //                return rows;
        //            }
        ...
        //                    PrepareCommand(connectionString, cmd, conn, trans, cmdText, cmdParms);
        //                    int val = cmd.ExecuteNonQuery();
        //                    cmd.Parameters.Clear();
        //                }
        //                trans.Commit();
        ...
        //private static void PrepareCommand(string connectionString,SqlCommand cmd, SqlConnection conn, SqlTransaction trans, string cmdText, SqlParameter[] cmdParms)
        //{
